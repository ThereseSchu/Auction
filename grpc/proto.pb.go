...
const file_proto_proto_rawDesc = "" +
	...
	"\vproto.proto\"#\n" +
	"\aMessage\x12\x18\n" +
	"\amessage\x18\x01 \x03(\tR\amessage\"\a\n" +
	"\x05Empty2R\n" +
	"\vITUDatabase\x12!\n" +
	"\vGetMessages\x12\x06.Empty\x1a\b.Message\"\x00\x12 \n" +
	"\fSendMessages\x12\b.Message\x1a\x06.EmptyB\x18Z\x16ITUDataBase/grpc/protob\x06proto3"
...
var file_proto_proto_depIdxs = []int32{
	1, // 0: ITUDatabase.GetMessages:input_type -> Empty
	0, // 1: ITUDatabase.SendMessages:input_type -> Message
	0, // 2: ITUDatabase.GetMessages:output_type -> Message
	1, // 3: ITUDatabase.SendMessages:output_type -> Empty
